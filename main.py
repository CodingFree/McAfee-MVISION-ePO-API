...
parser.add_argument('-H','--syslog_server',help='Syslog server host',default="localhost",required=False)
parser.add_argument('-B','--syslog_protocol',help='Syslog server protocol',default="TCP",required=False,choices=['TCP','tcp','UDP','udp'])
parser.add_argument('-P','--syslog_port',help='Syslog server port',default=514,required=False)
